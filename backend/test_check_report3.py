...
async def main():
    ...
    # Mock dnstwist with an async func
    import app.services.scanner.dns_check as dns_check
    async def mock_typo(*args, **kwargs):
        pass
    dns_check._check_typosquatting = mock_typo
    
    # Mock llm_security since it had CancelledError
    import app.services.scanner.llm_security_check as llm_security_check
    class MockLLMCheck:
        def __init__(self, *args, **kwargs):
            pass
        async def run(self):
            return {"api_security": {}, "llm_security": {}}
    
    import app.services.scanner.orchestrator as orch
    orch.LLMAndAPISecurityCheck = MockLLMCheck
