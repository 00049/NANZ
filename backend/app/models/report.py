...
class Report(Base):
    ...
    compliance_report = Column(
        JSONB, nullable=True
    )  # Module 9: DPDP/GDPR/PCI/SOC2/DORA
    ...
    severity_adjusted_count = Column(
        Integer, default=0
    )  # Findings with contextual severity
    ...
    compliance_report_v2 = Column(
        JSONB, nullable=True
    )  # Deep DPDP/GDPR/PCI/SOC2 report
